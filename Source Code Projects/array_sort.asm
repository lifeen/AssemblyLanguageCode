...
SORT_UTIL PROC
   ...
   COMPARE:
       ...
       AVVALI_MANFI:
           MOV AL, SECOND_NUMBER[DI]
           CMP AL, 2DH
           JE DOVVOMI_HAM_MANFI
           JMP AVVALI_MANFI_DOVVOMI_MOSBAT
           ...
           DOVVOMI_HAM_MANFI:
               ...
               COMPARE_HARDO_MANFI_LOOP:
                   ...
                   LOOP COMPARE_HARDO_MANFI_LOOP
               
               ;POP CX
               MOV CX, DONT_PUSH
               JMP CONTINUE
           
           AVVALI_MANFI_DOVVOMI_MOSBAT:
               MOV CX, DONT_PUSH 
               ;POP CX
               JMP CONTINUE
       ...
       AVVALI_MOSBAT:
           MOV AL, SECOND_NUMBER[DI]
           CMP AL, 2DH
           JE AVVALI_MOSBAT_DOVVOMI_MANFI
           JMP AVVALI_MOSBAT_DOVVOMI_MOSBAT
